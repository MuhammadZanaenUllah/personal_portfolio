...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-gray-200">
      <button
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl">
              ...
              <form id="contact-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-black text-white py-4 px-8 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98]"
                >
                  {isSubmitting ? (
