...
import { Mail, Phone, MapPin, Send, Github, Linkedin, Twitter, Calendar, Clock, Globe } from 'lucide-react';
...
export default function Contact() {
  ...
  const socialLinksWithColors = socialLinks.slice(0, 6).map(link => {
    ...
    return {
      ...
      color: colorMap[link.name] || 'hover:bg-gray-600'
    };
  });
  
  // Add email as a social link
  const allSocialLinks = [
    ...socialLinksWithColors,
    {
      name: 'Email',
          ...
          <div className="animate-fade-in-up animation-delay-400">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${personalInfo.email}`} className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                      {personalInfo.email}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${personalInfo.phone}`} className="text-gray-600 hover:text-green-600 transition-colors duration-300">
                      {personalInfo.phone}
                    </a>
                  </div>
                </div>
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      ...
                      className={`group flex flex-col items-center p-6 bg-gray-50 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-lg ${getHoverColor(social.name)} hover:text-white`}
                    >
            ...
            <div className="mt-8 bg-gradient-to-r from-green-50 to-blue-50 rounded-3xl p-8 border border-green-200">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-white text-gray-700 rounded-full text-sm font-medium">Web Development</span>
                <span className="px-3 py-1 bg-white text-gray-700 rounded-full text-sm font-medium">UI/UX Design</span>
                <span className="px-3 py-1 bg-white text-gray-700 rounded-full text-sm font-medium">Consulting</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 animate-fade-in-up animation-delay-600">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-3">What's your typical response time?</h3>
              <p className="text-gray-600">I usually respond to all inquiries within 24 hours. For urgent matters, feel free to reach out via phone or LinkedIn.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-3">What types of projects do you take on?</h3>
              <p className="text-gray-600">I specialize in web applications, e-commerce platforms, and custom software solutions. I'm always open to discussing unique challenges.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Do you offer ongoing support?</h3>
              <p className="text-gray-600">Yes! I provide maintenance, updates, and ongoing support for all projects. We can discuss support packages that fit your needs.</p>
            </div>
          </div>
        </div>
      </div>
