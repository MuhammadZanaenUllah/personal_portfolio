...
export default async function Home() {
  const { personalInfo, featuredProjects, featuredBlogPosts } =
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-fade-in-up animation-delay-600">
            <a
              href="/projects"
              className="group relative px-8 py-4 bg-black text-white rounded-full font-semibold transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-xl"
            >
            ...
            <a
              href="/contact"
              className="px-8 py-4 border-2 border-black text-black rounded-full font-semibold transition-all duration-300 hover:bg-black hover:text-white hover:scale-105 hover:shadow-xl"
            >
              Get In Touch
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            {[
              ...
              <div
                key={skill.name}
                className="group text-center p-6 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1"
              >
