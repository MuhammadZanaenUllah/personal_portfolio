...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for M.Zanaen Ullah portfolio website. Learn how we collect, use, and protect your personal information.',
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Welcome to M.Zanaen Ullah's portfolio website ("we," "our," or "us"). This Privacy Policy explains how we collect, 
                use, disclose, and safeguard your information when you visit our website zanaen.pk (the "Service").
              </p>
              <p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                This information may include your name, email address, phone number, and any message content you provide.
              </p>
